...
class CardDetailViewController: StatusBarAnimatableViewController, UIScrollViewDelegate {
    ...
    @objc func handleDismissalPan(gesture: UIPanGestureRecognizer) {
        ...
        let targetCornerRadius: CGFloat = Constants.CardAnimation.cardCornerRadius
    ...
    override func viewWillLayoutSubviews() {
        ...
        if Constants.CardAnimation.isEnabledTopSafeAreaInsetsFixOnCardDetailViewController {
