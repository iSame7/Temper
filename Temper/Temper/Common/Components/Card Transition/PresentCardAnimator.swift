...
final class PresentCardTransitionDriver {
    ...
    init(params: PresentCardAnimator.Params, transitionContext: UIViewControllerContextTransitioning, baseAnimator: UIViewPropertyAnimator) {
        ...
        let screens: (home: JobsViewController, cardDetail: CardDetailViewController) = (
            ctx.viewController(forKey: .from)! as! JobsViewController,
        ...
        let animatedContainerVerticalConstraint: NSLayoutConstraint = {
            switch Constants.CardAnimation.cardVerticalExpandingStyle {
            case .fromCenter:
        ...
        cardDetailView.layer.cornerRadius = Constants.CardAnimation.cardCornerRadius
